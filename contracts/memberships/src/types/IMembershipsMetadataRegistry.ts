...
export interface IMembershipsMetadataRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export interface IMembershipsMetadataRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMembershipsMetadataRegistryInterface;
