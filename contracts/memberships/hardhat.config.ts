...
const config: HardhatUserConfig = {
  ...
  dodoc: {
    runOnCompile: false,
    // There is a name matching issue causing generating doc for TestMembershipsFactory: https://github.com/primitivefinance/primitive-dodoc/issues/35
    include: ["Memberships", "MembershipsFactory", "MembershipsProxy", "MembershipsMetadataRegistry"],
    exclude: ["IMemberships", "IMembershipsFactory", "IMembershipsProxy", "IMembershipsMetadataRegistry"],
    outputDir: "docs",
  },
  packager: {
    contracts: [
