...
describe("ERC721SoulboundTokenNativeGaslessMint", () => {
  let ERC721: ERC721SoulboundTokenNativeGaslessMint__factory;
  let erc721: ERC721SoulboundTokenNativeGaslessMint;
  ...
  beforeEach(async () => {
    ERC721 = await ethers.getContractFactory(
      "ERC721SoulboundTokenNativeGaslessMint"
    );
