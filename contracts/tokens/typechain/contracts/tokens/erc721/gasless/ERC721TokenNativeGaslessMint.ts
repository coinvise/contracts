...
export interface ERC721TokenNativeGaslessMintInterface extends utils.Interface {
  functions: {
...
export interface ERC721TokenNativeGaslessMint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TokenNativeGaslessMintInterface;
