...
export interface ERC721SoulboundTokenNativeGaslessMintInterface
...
export interface ERC721SoulboundTokenNativeGaslessMint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721SoulboundTokenNativeGaslessMintInterface;
