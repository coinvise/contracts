...
export interface ERC721TokenGaslessMintInterface extends utils.Interface {
  functions: {
...
export interface ERC721TokenGaslessMint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TokenGaslessMintInterface;
