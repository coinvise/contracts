...
export interface ERC721TokenFactoryInterface extends utils.Interface {
  functions: {
...
export interface ERC721TokenFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TokenFactoryInterface;
