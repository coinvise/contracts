...
export interface ERC721TokenNativeGaslessMintImplInterface
...
export interface ERC721TokenNativeGaslessMintImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TokenNativeGaslessMintImplInterface;
