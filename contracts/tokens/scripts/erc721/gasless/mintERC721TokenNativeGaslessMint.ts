...
/**
 * Mint ERC721TokenNativeGaslessMint via OpenZeppelin Defender Relay using Biconomy's Native Meta transaction standard
 ...
 */
export const mintERC721TokenNativeGaslessMint = async (
  erc721: ERC721TokenNativeGaslessMint,
...
/**
 * Mint ERC721TokenNativeGaslessMint via Biconomy relays using Biconomy's Native Meta transaction standard
 ...
 * @param minter end-user signer who wants to mint
 */
export const mintERC721TokenNativeGaslessMintBiconomy = async (
  erc721: ERC721TokenNativeGaslessMint,
  admin: SignerWithAddress,
  minter: SignerWithAddress,
  to: string
...
const main = async () => {
  ...
  const ERC721TokenNativeGaslessMint: ERC721TokenNativeGaslessMint =
    ERC721TokenNativeGaslessMint__factory.connect(erc721, charlie);
