...
export interface CampaignsInterface extends utils.Interface {
  functions: {
    ...
    "createCampaign(address,uint256,uint256,uint256)": FunctionFragment;
...
export interface Campaigns extends BaseContract {
